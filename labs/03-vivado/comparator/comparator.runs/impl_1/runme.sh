...
HD_PWD='D:/Documents/xmacek26/digital-electronics-1/labs/03-vivado/comparator/comparator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comparator_4bit.tcl -notrace
